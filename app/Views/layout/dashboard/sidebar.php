<div class="container-fluid page-body-wrapper">
  ...
  $isDataMaster = in_array($currentPath, ['adminusers', 'adminanak', 'adminstatusgizi'], true);
  $isBasisAturan = in_array($currentPath, ['adminstandar', 'adminprior', 'adminlikelihood'], true);
    ...
    <ul class="nav">
      ...
      <li class="nav-item <?= $isDataMaster ? 'active' : ''; ?>">
        ...
        <div class="collapse <?= $isDataMaster ? 'show' : ''; ?>" id="tables">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item"><a class="nav-link <?= $currentPath === 'adminstatusgizi' ? 'active-submenu' : ''; ?>" href="<?= base_url('adminstatusgizi') ?>">Data Latih Status Gizi</a></li>
      ...
      <li class="nav-item <?= $isBasisAturan ? 'active' : ''; ?>">
        ...
        <div class="collapse <?= $isBasisAturan ? 'show' : ''; ?>" id="basis-aturan">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"><a class="nav-link <?= $currentPath === 'adminstandar' ? 'active-submenu' : ''; ?>" href="<?= base_url('adminstandar') ?>">Standar Antropometri</a></li>
            <li class="nav-item"><a class="nav-link <?= $currentPath === 'adminprior' ? 'active-submenu' : ''; ?>" href="<?= base_url('adminprior') ?>">Prior Naive Bayes</a></li>
            <li class="nav-item"><a class="nav-link <?= $currentPath === 'adminlikelihood' ? 'active-submenu' : ''; ?>" href="<?= base_url('adminlikelihood') ?>">Likelihood Naive Bayes</a></li>
          </ul>
        </div>
      </li>
